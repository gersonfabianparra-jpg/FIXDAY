...
export const metadata: Metadata = {
  title: 'Visita + Diagnóstico Técnico a Domicilio $20.000 | FIXDAY',
  description: 'Visita a domicilio + diagnóstico técnico por $20.000. El valor se aplica al total si realizas la reparación. Técnico certificado en toda la Región Metropolitana.',
  openGraph: {
    title: 'FIXDAY — Visita + Diagnóstico a domicilio $20.000 🔧',
    description: 'Técnico a domicilio en toda la RM. Diagnóstico incluido, sin traslados, mismo día.',
  ...
  twitter: {
    ...
    title: 'FIXDAY — Visita + Diagnóstico a domicilio $20.000 🔧',
    description: 'Técnico a domicilio en toda la RM. Sin traslados, mismo día.',
  },
}
    ...
    <div style={{ minHeight: '100vh', background: '#000', color: '#F5F5F7', fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif' }}>
      ...
      <section style={{ padding: '72px 0 60px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 680, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
          ...
          {/* Badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(41,151,255,.1)', border: '1px solid rgba(41,151,255,.3)', borderRadius: 980, padding: '7px 18px', fontSize: 12, fontWeight: 700, color: '#2997FF', letterSpacing: '.1em', textTransform: 'uppercase', marginBottom: 28 }}>
            🔧 Técnico certificado a domicilio · Región Metropolitana
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, marginBottom: 32 }}>
            <span style={{ fontSize: 'clamp(2.8rem,7vw,5rem)', fontWeight: 900, color: '#F5F5F7', letterSpacing: '-.04em', lineHeight: 1 }}>$20.000</span>
          </div>
      ...
      <section style={{ padding: '60px 0 80px', textAlign: 'center' }}>
        <div style={{ maxWidth: 480, margin: '0 auto', padding: '0 24px' }}>
          <p style={{ color: '#636366', fontSize: '0.95rem', marginBottom: 24, lineHeight: 1.7 }}>
            Escríbenos ahora y agenda tu visita técnica a domicilio. Respondemos en menos de una hora.
          </p>
          <a href={WA} target="_blank" rel="noopener noreferrer"
